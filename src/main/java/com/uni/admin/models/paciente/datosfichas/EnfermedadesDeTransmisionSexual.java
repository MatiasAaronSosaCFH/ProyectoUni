...
@Data
@EqualsAndHashCode
@Table(name = "enfermedades_de_transmision_sexual")
public class EnfermedadesDeTransmisionSexual {
    ...
    private EnfermedadesDeTransmisionSexualENUM enfermedadesDeTransmisionSexualENUM;
}
