...
@EqualsAndHashCode
@Data
@Table(name = "enfermedades_cardiovasculares")
public class EnfermedadesCardiovasculares {
    ...
    private EnfermedadesCardiovascularesENUM enfermedadesCardiovascularesENUM;
}
